...
module.exports.listen = function(server)
{
  ...
  {
    stream.write(JSON.stringify({ id: "device1", lastComm: "123", deviceType: "ipod", status: "alive" }));
    setTimeout(function()
    {
      stream.write(JSON.stringify({ id: "device2", lastComm: "123", deviceType: "ipod", status: "alive" }));
    }, 2000);
